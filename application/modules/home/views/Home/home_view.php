...
<html lang="en">
  ...
  <style>
    .bg-img{
      background: url('assets/images/bg-1.jpeg') fixed;
      position: relative;
      margin: 0;
  ...
  <body class="no-skin">
    ...
    <div id="navbar" class="navbar navbar-default" style="background: gold">
...
>>>>>>> 4b8fb8ceef5d2b8904b7a8f9840414adc3e20e4f
        <!-- /section:basics/sidebar.layout.minimize -->
        <script type="text/javascript">
...
<<<<<<< HEAD
                ...
                <div id="page-area-content" class="bg-img">
=======
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <div class="table-header">
              ...
              <span id="text_title_large">TITLE</span>
...
<<<<<<< HEAD
    ...
    <script type="text/javascript">
      ...
      function getStatus() {
          $('#count_notif').load('Templates/notification/getNotif').fadeIn("slow");
          setTimeout("getStatus()",10000);  // refresh every 30000 milliseconds (30 seconds)
      }
...
>>>>>>> 4b8fb8ceef5d2b8904b7a8f9840414adc3e20e4f
      ...
      function update_status_pengajuan_revisi(pr_id, status, flag){

        if(confirm('Are you sure?')){
          $.ajax({
              url: 'penganggaran/T_pengajuan_revisi/update_status_pengajuan',
              type: "post",
              data: {pr_id : pr_id, status : status, flag : flag},
              dataType: "json",
              beforeSend: function() {
                achtungShowLoader();  
              },
