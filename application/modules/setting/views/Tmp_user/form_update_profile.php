          ...
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_update_profile" action="<?php echo site_url('setting/Tmp_user/process_profile_user')?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-2">Signature Image</label>
                    <div class="col-md-8">
                      <input type="file" name="signature" class="form-control" id="signature" style="width: 200px">
                      <span>Untuk membuat signature digital, gunakan link dibawah ini <br><a href="https://signaturely.com/online-signature/draw/" target="_blank">https://signaturely.com/online-signature/draw/</a></span>
                    </div>
                  </div>
                  <?php if(isset($value->signature_path)) :?>

                     <div class="form-group">
                        <label class="control-label col-md-2">&nbsp;</label>
                        <div class="col-md-4">
                          <img style="max-width:150px; min-width: 100px" class="editable img-responsive" alt="<?php echo $this->session->userdata('user')->fullname?>" id="avatar2" src="<?php echo base_url().PATH_PHOTO_PROFILE_DEFAULT.$value->signature_path?>" />
                        </div>
                      </div>
